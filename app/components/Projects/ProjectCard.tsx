...
const ProjectCard = ({ url, desc, title, idx }: props) => {
  return (
    <div
      key={idx}
      className="cardAnime z-10 w-full gap-50   bg-white text-black  px-20 h-screen py-10 text-8xl flex justify-between"
    >
      <div className="z-10">
      ...
      <div className="z-10 w-full  px-32  h-full flex flex-col gap-10">
        ...
        <div className=" text-4xl z-10 tracking-tight">
          <h1>{desc}</h1>
        </div>
      </div>
    </div>
